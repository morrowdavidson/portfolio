...
Ext.Loader.addClassPathMappings({
  ...
  "iPanel": "app/view/InsectCarousel.js"
});
Ext.ClassManager.addNameAlternateMappings({
  "BugApp.controller.CarouselController": [],
  "BugApp.controller.FilterFormController": [],
  "BugApp.controller.InfoTabController": [],
  "BugApp.controller.InsectPanelController": [],
  "BugApp.controller.PhotoCarouselController": [],
  "BugApp.model.Insect": [],
  "BugApp.model.InsectPhoto": [],
  "BugApp.store.InsectInfo": [],
  "BugApp.view.FilterFormPanel": [],
  "BugApp.view.InfoTabPanel": [],
  "BugApp.view.InsectCarousel": [],
  "BugApp.view.InsectPanel": [],
  "BugApp.view.InsectPhotoCarousel": [],
  "BugApp.view.Main": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "BugApp.controller.FilterFormController": [],
  "BugApp.controller.InfoTabController": [
    "widget.infotabcontroller"
  ],
  "BugApp.controller.InsectPanelController": [
    "widget.insectpanelcontroller"
  ],
  "BugApp.controller.PhotoCarouselController": [
    "widget.photocarouselcontroller"
  ],
  "BugApp.model.Insect": [],
  "BugApp.model.InsectPhoto": [],
  "BugApp.store.InsectInfo": [],
  ...
  "BugApp.view.InsectCarousel": [
    "widget.InsectCarousel"
  ],
  "BugApp.view.InsectPanel": [
    "widget.insectpanel"
  ],
  "BugApp.view.InsectPhotoCarousel": [
    "widget.insectphotocarousel"
  ],
  "BugApp.view.Main": [
    "widget.main"
  ],
