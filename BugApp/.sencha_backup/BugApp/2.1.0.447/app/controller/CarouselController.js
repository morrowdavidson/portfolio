...
Ext.define('BugApp.controller.CarouselController', {
    ...
    infoTap: function(){
        Ext.Viewport.setActiveItem(infoTabPanelView,{type: 'slide', direction:'up',cover:true});
    },
    filterTap: function(){

        Ext.Viewport.setActiveItem(filterFormPanelView);
    ...
    toolBarTap: function(){
        ...
        insectCarouselView.items.items[1]._title.setHtml('Bugs in the Garden')
